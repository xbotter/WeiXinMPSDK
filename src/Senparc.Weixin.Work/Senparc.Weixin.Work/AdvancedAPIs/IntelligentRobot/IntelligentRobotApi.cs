...
namespace Senparc.Weixin.Work.AdvancedAPIs.IntelligentRobot
{
    ...
    public static class IntelligentRobotApi
    {
        ...
        /// <returns></returns>
        public static GetRobotListResult GetRobotList(string accessTokenOrAppKey, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format(Config.ApiWorkHost + "/cgi-bin/robot/list?access_token={0}", accessToken.AsUrlData());
                return CommonJsonSend.Send<GetRobotListResult>(null, url, null, CommonJsonSendType.GET, timeOut);
            }, accessTokenOrAppKey);
        }
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static CreateRobotResult CreateRobot(string accessTokenOrAppKey, string name, string description = null, string avatar_mediaid = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                ...
                return CommonJsonSend.Send<CreateRobotResult>(accessToken, url, data, CommonJsonSendType.POST, timeOut);
            }, accessTokenOrAppKey);
        }
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WorkJsonResult UpdateRobot(string accessTokenOrAppKey, string robot_id, string name = null, string description = null, string avatar_mediaid = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                ...
                return CommonJsonSend.Send<WorkJsonResult>(accessToken, url, data, CommonJsonSendType.POST, timeOut);
            }, accessTokenOrAppKey);
        }
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static GetRobotDetailResult GetRobotDetail(string accessTokenOrAppKey, string robot_id, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                ...
                return CommonJsonSend.Send<GetRobotDetailResult>(null, url, null, CommonJsonSendType.GET, timeOut);
            }, accessTokenOrAppKey);
        }
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WorkJsonResult DeleteRobot(string accessTokenOrAppKey, string robot_id, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static SendRobotMessageResult SendRobotMessage(string accessTokenOrAppKey, SendRobotMessageRequest data, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format(Config.ApiWorkHost + "/cgi-bin/robot/send?access_token={0}", accessToken.AsUrlData());
                return CommonJsonSend.Send<SendRobotMessageResult>(accessToken, url, data, CommonJsonSendType.POST, timeOut);
            }, accessTokenOrAppKey);
        }
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static GetRobotChatRecordResult GetRobotChatRecord(string accessTokenOrAppKey, string robot_id, string cursor = null, int limit = 100, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                ...
                return CommonJsonSend.Send<GetRobotChatRecordResult>(accessToken, url, data, CommonJsonSendType.POST, timeOut);
            }, accessTokenOrAppKey);
        }
